...
const CoursesUncompleted = () => {
    ...
    const { data, isLoading } = useQuery({
      ...
      queryFn: async () => {
        const { response, error } = await courseApi.getByStatus(CourseStatus.DRAFT, { pageNumber: page, pageSize: 5 }, user.id)
          ...
          })}>
            {
                ...
                ?   (
                    <div className='w-full h-80 rounded-xl p-10 flex flex-col items-center justify-center
                        ...
                        <div className='flex flex-col text-gray-500 text-xl text-center'>
                            <span>Rất tiếc. Bạn chưa có bản nháp nào!</span>
                            <span>Tạo bản nháp khóa học</span>
                        </div>
                    </div>
                ): (
                    <div>
                                                ...
                                                data?.content.map((course, _) => (
                                                    <tr key={course.id}>
                                                        ...
                                                        <td className='py-3'>
                                                            ...
                                                            <i className="w-2 h-2 rounded-full bg-draft"></i>
                                                                Bản nháp
                                                            </span>
                                                        </td>
                                                        <td className='py-3'>
...
export default CoursesUncompleted
